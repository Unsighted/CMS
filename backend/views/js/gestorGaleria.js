...
$("#lightbox").on("drop", function(e){
	...
	for(var i = 0; i < archivo.length; i++){
		...
		if(Number(imagenSize[i]) > 2000000){
			...
			$("#lightbox").before('<div class="alert alert-warning alerta text-center">El archivo excede el peso permitido, 10mb</div>')
			...
			$.ajax({
				...
				success: function(respuesta){
					...
					if(respuesta == 0){
						...
						$("#lightbox").before('<div class="alert alert-warning alerta text-center">La imagen es inferior a 800px * 400px</div>')
