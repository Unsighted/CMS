...
function reloj(){
	...
	// Capturando el atributo del id hora con sus correspondientes valores: h:m:s y meridiano.
	...
	setInterval(function(){
		...
		if(segundos == 59){
			...
			segundos = "0" + 0; // Se genera 00.

			minutos = Number(minutos) + 1; // Se incrementa el minuto actual + 1.
			...
			if(segundos > 0 && segundos < 10){ // Se agregará un cero para quedar: 01, 02, 03 .. etc, luego del 09 se quitará el cero.
	...
	},1000); // La función se ejecutará cada 1 segundo.
