	...
	<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12" id="col1">
		...
		<nav id="botonera" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 collapse navbar-collapse text-center">
			...
			<ul class="nav navbar">
				...
				<li><a href="album">Carrousel <span class="glyphicon glyphicon-new-window"></span></a></li>
				...
				<li><a href="../index.php" id="btn_versitio" target="_blank"><button type="button" class="btn">Ver sitio</button></a></li>
